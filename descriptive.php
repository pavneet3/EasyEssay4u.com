...
<html>
    <head>
         <title><?php  echo 'Descriptive'.' | '.$site_title; ?> </title>
       <meta charset="utf-8">
                           ...
                           <!--/header-->  
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        $q="SELECT * FROM topics WHERE category LIKE '%escriptive' ORDER BY title ASC LIMIT 50";
                                   ...
                                   <a href="TopicContent.php?topic=<?php echo $list['title'];?>&id=<?php echo $list[id];?>" class="list-group-item-heading"><?php echo $list['title']; ?>
                                       ...
                                       <?php  //to fetch the list from db
                                            ...
                                            $q="SELECT * FROM topics WHERE category LIKE '%escriptive' ORDER BY title ASC LIMIT 50,100";
                                           $r=mysqli_query($dbc, $q);
                                           while($list = mysqli_fetch_assoc($r)){
                                       //$blurb=  substr($list['body'],0,10); //to print the body of essay from db
                                       ...
                                       <?php  //to fetch the list from db
                                        ...
                                        $q="SELECT * FROM topics WHERE category LIKE '%escriptive' ORDER BY title ASC LIMIT 100,150";
                                       $r=mysqli_query($dbc, $q);
                                       while($list = mysqli_fetch_assoc($r)){
                                   //$blurb=  substr($list['body'],0,10); //to print the body of essay from db
